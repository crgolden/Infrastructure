...
Continuously polls 9 critical services on the host machine (`deeprog.servehttp.com`) and:
...
### Observability
- **Serilog** + Elasticsearch sink (pinned to `[8.11.1]` to match self-hosted ES 8.x), console sink bootstrap
