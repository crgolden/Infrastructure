...
public sealed class HomeAssistantHealthCheckTests
{
    ...
    private static IOptions<ServiceEndpointOptions> GetDefaultOptions() => Options.Create(new ServiceEndpointOptions { HomeAssistant = new Uri(Generated.NewServiceAddress()) });
