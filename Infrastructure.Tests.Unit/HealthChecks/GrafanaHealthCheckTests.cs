...
public sealed class GrafanaHealthCheckTests
{
    ...
    private static IOptions<ServiceEndpointOptions> GetDefaultOptions() => Options.Create(new ServiceEndpointOptions { Grafana = new Uri(Generated.NewServiceAddress()) });
