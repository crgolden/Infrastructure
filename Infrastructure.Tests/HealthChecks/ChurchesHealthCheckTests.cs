...
public sealed class ChurchesHealthCheckTests
{
    ...
    {
        var check = new ChurchesHealthCheck(BuildClient(HttpStatusCode.OK, "Healthy"), GetDefaultConfiguration());
    ...
    {
        var check = new ChurchesHealthCheck(BuildClient(HttpStatusCode.OK, "Degraded"), GetDefaultConfiguration());
        var context = new HealthCheckContext { Registration = new HealthCheckRegistration("Churches", check, null, null) };
