...
public sealed class KibanaHealthCheckTests
{
    ...
    {
        var check = new KibanaHealthCheck(BuildFactory(HttpStatusCode.OK), GetDefaultOptions());
    ...
    {
        var check = new KibanaHealthCheck(BuildThrowingFactory(new HttpRequestException("connection refused")), GetDefaultOptions());
        var context = new HealthCheckContext { Registration = new HealthCheckRegistration("Kibana", check, null, null) };
    ...
    {
        var check = new KibanaHealthCheck(BuildFactory(HttpStatusCode.ServiceUnavailable), GetDefaultOptions());
        var context = new HealthCheckContext { Registration = new HealthCheckRegistration("Kibana", check, null, null) };
