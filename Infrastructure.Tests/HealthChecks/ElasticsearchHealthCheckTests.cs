...
public sealed class ElasticsearchHealthCheckTests
{
    ...
    {
        var check = new ElasticsearchHealthCheck(BuildFactory(HttpStatusCode.OK), GetDefaultOptions());
    ...
    {
        var check = new ElasticsearchHealthCheck(BuildFactory(HttpStatusCode.ServiceUnavailable), GetDefaultOptions());
        var context = new HealthCheckContext { Registration = new HealthCheckRegistration("Elasticsearch", check, null, null) };
    ...
    {
        var check = new ElasticsearchHealthCheck(BuildThrowingFactory(new HttpRequestException("timeout")), GetDefaultOptions());
        var context = new HealthCheckContext { Registration = new HealthCheckRegistration("Elasticsearch", check, null, null) };
